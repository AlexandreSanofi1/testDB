...
# Get the MongoDB URI and password from the .env file
mongodb_uri = os.getenv("MONGODB_URI")
mongodb_password = os.getenv("MONGODB_PASSWORD")  # If you choose to store the password separately

# Replace <insertPassword> with the actual password in the URI if using a placeholder
mongodb_uri = mongodb_uri.replace('12345678', mongodb_password)
