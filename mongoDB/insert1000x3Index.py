...
for i in range(1, 1001):
    # Construct the document with random numbers
    document = {
        ...
        'RandomNumber1': random.randint(1, 100),  # Random number between 1 and 100
        'RandomNumber2': random.randint(1, 100),  # Random number between 1 and 100
        'RandomNumber3': random.randint(1, 100)   # Random number between 1 and 100
    }
